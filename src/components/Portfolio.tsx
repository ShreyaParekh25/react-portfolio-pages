...
const Portfolio = () => {
  ...
  const projects: Project[] = [
    {
      id: 1,
      title: "RAG Chatbot using LLM & LLaMA",
      category: "AI/ML",
      image: "https://images.unsplash.com/photo-1677442136019-21780ecad995",
      description:
        "Built an AI-powered Retrieval-Augmented Generation (RAG) chatbot using LLMs and LLaMA model. The system retrieves relevant context from documents and generates intelligent responses using Python-based backend logic.",
      technologies: [
        "Python",
        "LLaMA",
        "LLM",
      ...
      githubUrl: "https://github.com/ShreyaParekh25/My-First-RagChatboat",
      liveUrl: "#"
    },
    {
      id: 2,
      title: "JewelMarketer (Angular Frontend)",
      category: "web",
      image: "https://images.unsplash.com/photo-1601121141461-9d6647bca1ed",
      description:
        "A modern Angular-based frontend application for managing jewelry marketing, product showcase, and customer interactions with a clean UI and responsive design.",
      technologies: [
        "Angular",
        "TypeScript",
        "HTML",
    ...
    // },
    {
      ...
      description: "A Figma-powered prototype optimizing food delivery through seamless UX and real-time efficiency.",
      ...
      <div className="section-container">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-400">
            Full Stack & AI-focused projects
          </p>
        </div>

        {/* Filter buttons */}
        <div className="flex flex-wrap justify-center gap-3 mb-10">
          {['all', 'AI/ML', 'web', 'mobile', 'prototype'].map((filter) => (
            <button
              key={filter}
              onClick={() => setActiveFilter(filter)}
              className={`px-4 py-2 rounded-full capitalize transition-all duration-300 ${activeFilter === filter
