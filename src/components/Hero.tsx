        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          ...
          <div className="order-2 lg:order-1 animate-slide-right">
            ...
            <h2 className="text-2xl md:text-3xl font-semibold mb-6">
              And I'm a <span className="text-highlight">Full Stack Developer with UI/UX Skills</span>
            </h2>
            
            <p className="text-muted-foreground text-lg mb-8 max-w-lg">
            I am a Full-Stack Developer with a strong foundation in UI/UX design, dedicated to building engaging, user-centric digital solutions. My expertise lies in bridging the gap between design vision and technical execution, crafting seamless experiences from the initial wireframe to the final deployment. I leverage a holistic understanding of the product lifecycle to deliver robust, aesthetically pleasing, and highly functional web applications.
            </p>
