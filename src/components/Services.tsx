  ...
  const services: Service[] = [
    {
      ...
      description:
        "Building AI-powered applications and intelligent chatbot systems for modern web experiences.",
      icon: <span className="text-3xl">🤖</span>,
      features: [
        "AI Chatbot Development (OpenAI API)",
        "AI-powered Web Integration",
        "Prompt Engineering",
        "Automation using AI tools",
        "Basic RAG-based systems (learning stage)"
      ]
    },
    {
    ...
    <section id="services" className="py-20 relative">
      ...
      <div className="section-container">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-400 mt-2 mt-[15px]">Full Stack, UI/UX & AI-powered development services</p>
        </div>
